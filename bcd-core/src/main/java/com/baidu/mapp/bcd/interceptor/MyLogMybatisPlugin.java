package com.baidu.mapp.bcd.interceptor;
...
public class MyLogMybatisPlugin implements Interceptor {

    private static final Logger LOGGER = LoggerFactory.getLogger(MyLogMybatisPlugin.class);
